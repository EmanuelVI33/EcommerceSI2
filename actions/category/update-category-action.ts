...
export async function updateCategoryAction(formData: FormData) {
    ...
    try {
        ...
        const response = await axiosClient.put<ResponseMessage<Category>>(`/admin/categories/${formData.get('id')}`, formData, {
            headers: {
...
// export async function updateCategoryAction(categoryForm: CategoryWithImage) {
